    ...
    <div className="group flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 rounded-xl border border-border bg-card/80 p-4 sm:p-5 transition-all hover:border-primary/40 hover:shadow-lg">
      ...
      <div className="flex shrink-0 justify-center w-full sm:w-auto">
        <img
          ...
          className="h-24 w-24 sm:h-28 sm:w-28 rounded-lg border bg-white p-2 shadow-sm transition-transform group-hover:scale-105 dark:bg-white"
          loading="lazy"
        />
      </div>
      ...
      >
        <div className="flex items-center gap-2">
          <h2 className="truncate text-xl sm:text-2xl font-bold transition-colors group-hover/link:text-primary">
        ...
        <div className="flex items-center gap-2">
          <p className="truncate text-base sm:text-lg font-medium text-primary hover:text-primary/80 transition-colors">
            {shortUrl}
          </p>
        </div>

        <p className="truncate text-sm text-muted-foreground transition-colors">
          {url?.original_url}
        </p>
      ...
      {/* Actions */}
      <div className="flex shrink-0 items-center gap-2 self-end sm:self-center w-full sm:w-auto justify-end sm:justify-start border-t sm:border-t-0 border-border pt-3 sm:pt-0 mt-2 sm:mt-0">
        <Button
          size="icon"
          variant="ghost"
